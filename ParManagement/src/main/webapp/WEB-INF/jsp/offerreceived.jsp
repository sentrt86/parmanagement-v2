	...
	<head>
		...
		<link rel="stylesheet" href="static/css/offerreceived.css">	
		...
		<script type="text/javascript" src="static/js/offerreceived.js"></script>
	</head>
	<body>
			...
			<div class="main">
				<div>
			    	<h1 class="screen-title">Offer Received</h1>
			    </div>
				<form class="form-top">
				  <div class="row">
				...
				<div class="tablediv">
			    	<table id="offerReceivedTable" class="table table-striped table-bordered" style="width:100%">
					     <thead>
					         <tr>
