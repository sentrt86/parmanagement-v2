	...
	<head>
		...
		<title>Prescreening Result</title>
		...
		<link rel="stylesheet" href="static/css/prescreeningresults.css">	
		...
		<script type="text/javascript" src="static/js/prescreeningresults.js"></script>
	</head>
	<body>
			...
			<div class="main">
				<div>
			    	<h1 class="screen-title">Prescreening Results</h1>
			    </div>
				<form class="form-top">
				  <div class="row">
				...
				<div class="tablediv">
			    	<table id="prescreeningResultsTable" class="table table-striped table-bordered" style="width:100%">
					     <thead>
					         <tr>
					             <th>Candidate Name</th>
					             <th>Prescreener Name</th>
					             <th>Prescreening Result</th>
					             <th>Action</th>
					         </tr>
					     </thead>
					     <tbody>
