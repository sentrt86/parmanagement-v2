	...
	<head>
		...
		<link rel="stylesheet" href="static/css/setupsubmitted.css">	
		...
		<script type="text/javascript" src="static/js/setupsubmitted.js"></script>
	</head>
	<body>
			...
			<div class="main">
				<div>
			    	<h1 class="screen-title">Setup Submission</h1>
			    </div>
				<form class="form-top">
				  <div class="row">
				...
				<div class="tablediv">
			    	<table id="setupSubmittedtable" class="table table-striped table-bordered" style="width:100%">
					     <thead>
					         <tr>
					             <th>Candidate Name</th>
					             <th>Start Date</th>
					             <th>Setup Submission Date</th>
					             <th>Action</th>
					         </tr>
					     </thead>
					     <tbody>
